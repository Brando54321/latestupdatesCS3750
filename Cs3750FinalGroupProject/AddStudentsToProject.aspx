<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddStudentsToProject.aspx.cs" Inherits="Cs3750FinalGroupProject.AddStudentsToProject" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server"> <div>
            Add students into projects by submitting the students user ID<br />
            <table>
