<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RemoveFromGroup.aspx.cs" Inherits="Cs3750FinalGroupProject.RemoveFromGroup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server"> <div>
            Remove students into groups by submitting the students user ID<br />
            <table>
